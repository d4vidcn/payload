(function(a,b){
	...
	function c$(a,b){
		var c,d={height:a},e=0;b=b?1:0;for(;e<4;e+=2-b)c=bV[e],d["margin"+c]=d["padding"+c]=a;
	...
	p.fn=p.prototype={
		...
		a?p.readyWait++:p.ready(!0)},ready:function(a){
			...
			return a.replace(A,"ms-").replace(B,C)},nodeName:function(a,b){
				...
				return a.length=e,a},grep:function(a,b,c){
					...
					c=!!c;for(;f<g;f++)d=!!b(a[f],f),c!==d&&e.push(a[f]);
					return e
				},map:function(a,c,d){
					...
					return g.concat.apply([],g)},guid:1,proxy:function(a,c){
						...
						return typeof c=="string"&&(d=a[c],c=a,a=d),p.isFunction(a)?(e=k.call(arguments,2),f=function(){
						...
						},f.guid=a.guid=a.guid||p.guid++,f):b},access:function(a,c,d,e,f,g,h){
							...
							if(d&&typeof d=="object"){
								...
								if(c)for(;k<l;k++)c(a[k],d,i?e.call(a[k],k,c(a[k],d)):e,h);f=1
							}
									...
									valHooks:{
										option:{
											...
											get:function(a){
												...
												for(;c<d;c++){
													e=h[c];if(e.selected&&(p.support.optDisabled?!e.disabled:e.getAttribute("disabled")===null)&&(!e.parentNode.disabled||!p.nodeName(e.parentNode,"optgroup"))){b=p(e).val();if(i)return b;g.push(b)}
												}
